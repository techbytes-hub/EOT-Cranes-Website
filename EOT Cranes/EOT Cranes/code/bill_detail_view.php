...
<body>
  ...
  <tr>
    ...
    <td>&nbsp;<a href="bill_details_edit.php?bd_id=<?php echo $row['bill_details_id'];?>"><img src="../image/edit.jpg" width="30" height="30"></a></td>
    <td>&nbsp;<a href="bill_details_delete.php?b_id=<?php echo $row['bill_details_id'];?>"onClick="return confirm('Are you sure want to delete')"><img src="../image/delete.png" width="30" height="30"></a></td>
  </tr>
  <?php
  }
  ?>
