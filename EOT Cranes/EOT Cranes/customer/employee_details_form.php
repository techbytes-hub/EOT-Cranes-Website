...
<form name="formID" ID="formID" method="post" action="employee_details_insert.php">
  ...
  <table width="384" height="389" border="0" align="center">
    <tr>
      ...
      <td width="125"><input name="employee_name" type="text" id="employee_name"  class="form-control validate[required,custom[onlyNumber]]"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Gender</td>
      <td><input name="gender" type="text" id="gender"  class="form-control validate[required,custom[onlyLetter]]"></td>
    </tr>
    <tr>
      <td>Contact No </td>
