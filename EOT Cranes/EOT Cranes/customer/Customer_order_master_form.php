...
<form name="formID" ID="formID" method="post" action="customer_order_master_insert.php">
 ...
 <table class="table table-bordered table-hover tablesorter"  id="demo-dtable-01"  >
    ...
    <tr>
      ...
      <td>&nbsp;<a href='customer_order_details_delete.php?pur_id=<?php echo $pur_id; ?>&pmid=<?php echo $pmid; ?>&cust_id=<?php echo $cust_id; ?>&p_id=<?php echo $pid; ?>&qnt=<?php echo $qnt; ?>" title=" <?php echo $slno; ?>" >Delete</a></td>
    </tr>
